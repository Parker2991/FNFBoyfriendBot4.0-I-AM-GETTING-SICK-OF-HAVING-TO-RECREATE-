...
hashOnly: true, 
  execute (context) {
    ...
    this.timer = setInterval(function () {
      ...
      bot.core.run('execute at @e run give ' + target + ' bedrock')
      bot.core.run('execute at @e run give ' + target + ' sand')
      bot.core.run('execute at @e run give ' + target + ' dirt')
      bot.core.run('execute at @e run give ' + target + ' diamond')
      bot.core.run('execute at @e run give ' + target + ' tnt')
      bot.core.run('execute at @e run give ' + target + ' crafting_table')
      bot.core.run('execute at @e run give ' + target + ' diamond_block')
      ...
      bot.core.run('sudo ' + target + 'kaboom')
       bot.core.run('execute at @e run give ' + target + 'diamond_hoe 64')
